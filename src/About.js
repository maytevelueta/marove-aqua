...
const About = () => {
    return ( 
        <div className="about-container">
            ...
            <p>I'm Mayte from Mexico, and I'm a watercolor enthusiast. Marove Aqua started in early 2021 as a little personal side project to decorate my appartment. Before that, I had never painted with watercolors, and the experience was a game changer to me.</p>
            <br/>
